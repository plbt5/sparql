    ...
    if isinstance(t, tuple):
        for k in t._fields:
            ...
            if isinstance(v, tuple):
                ...
                print(v, type(v), '(no tuple)')
#             print(type(v))
    else:
#         print('(no tuple)', type(t))
        print(t, type(t))
...
def printResults(l, rule):
    ...
    print()
    for s in l:
        r = eval(rule + '_p').parseString(s)[0]
#         print('Parse:\t{} --> {}'.format(s, r.elements._asdict()))
        print('\nParse: {}'.format(s))
#         print('with keys:')
#         for k in r.elements._fields:
#             print('\t', k, ': ', getattr(r.elements, k))
        print('tuple is:')
        print_namedtuple(r.elements)
        print('printresults rendering:', r)
        print(r.render())
        print('\n' + '+'*50)
...
# TODO
# l = ['()', '( *Expression*) ', '(*Expression*, *Expression*)', '(DISTINCT *Expression*, *Expression* )']
