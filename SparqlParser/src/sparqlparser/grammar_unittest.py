...
# [39]    DeleteData        ::=   'DELETE DATA' QuadData 
        ...
        self.testCases['DeleteData']['pass'] += ['DELETE DATA ' + q for q in self.testCases['QuadPattern']['pass'][::10]]
        self.testCases['DeleteData']['fail'] += ['*NoDeleteData*']
        
# [38]    InsertData        ::=   'INSERT DATA' QuadData 
        self.testCases['InsertData'] = {'pass': [], 'fail': []}
        self.testCases['InsertData']['pass'] += ['INSERT DATA ' + q for q in self.testCases['QuadPattern']['pass'][::10]]
